import { marketingSkillData } from "../Data/SkillData"

function MarketingAssociatesSkill() {
    return (
        <div className="px-[5%] pb-12">
            <div className="skillCardContainer gap-6 mt-4 w-full p-4">
                {
                    marketingSkillData.map((item, index) => (
...
export default MarketingAssociatesSkill
