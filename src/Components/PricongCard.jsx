        ...
        <div className="pricingContainer">
            ...
            <div id='pricingCard' className='relative bg-white py-6 px-4 pb-16'>
                ...
                <div className="flex items-center justify-center mt-8 mb-4 ">
                    <button className="px-7 py-2.5 absolute bottom-10 shadow-sm rounded-full bg-mainGreen text-white font-semibold hover:scale-110 hover:bg-black transition duration-300">Get Started</button>
                </div>
            </div>
            {/* 1st card end */}
